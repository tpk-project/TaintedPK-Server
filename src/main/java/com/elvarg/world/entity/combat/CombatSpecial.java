...
import com.elvarg.world.entity.combat.method.impl.specials.AbyssalBludgeonCombatMethod;
import com.elvarg.world.entity.combat.method.impl.specials.AbyssalDaggerCombatMethod;
...
import com.elvarg.world.entity.combat.method.impl.specials.DragonWarhammerCombatMethod;
...
import com.elvarg.world.entity.combat.method.impl.specials.SaradominSwordCombatMethod;
...
public enum CombatSpecial {
	...
	DRAGON_WARHAMMER(new int[] { 13576 }, 50, 1.67, 1.39, new DragonWarhammerCombatMethod(), WeaponInterface.WARHAMMER),

	SARADOMIN_SWORD(new int[] { 11838 }, 100, 1.1, 1.3, new SaradominSwordCombatMethod(), WeaponInterface.SARADOMIN_SWORD),

	ARMADYL_GODSWORD(new int[] { 11802 }, 50, 1.50, 1.6, new ArmadylGodswordCombatMethod(), WeaponInterface.GODSWORD),
	SARADOMIN_GODSWORD(new int[] { 11806 }, 50, 1.27, 1.5, new SaradominGodswordCombatMethod(), WeaponInterface.GODSWORD),
	BANDOS_GODSWORD(new int[] { 11804 }, 100, 1.22, 1.4, new BandosGodswordCombatMethod(), WeaponInterface.GODSWORD),
	ZAMORAK_GODSWORD(new int[] { 11808 }, 50, 1.15, 1.4, new ZamorakGodswordCombatMethod(), WeaponInterface.GODSWORD),

	ABYSSAL_BLUDGEON(new int[] { 13263 }, 50, 1.20, 1.37, new AbyssalBludgeonCombatMethod(), WeaponInterface.ABYSSAL_BLUDGEON),
	...
	DARK_BOW(new int[] { 11235 }, 55, 1.29, 1.24, new DarkBowCombatMethod(), WeaponInterface.DARK_BOW),
